      ...
      >
        ...
        <el-table-column prop="fileStatus" label="文件状态" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.fileStatus == 2">放款成功</span>
            <span v-if="scope.row.fileStatus == 5">放款成功</span>
            <span v-if="scope.row.fileStatus == 6">放款成功</span>
            <span v-if="scope.row.fileStatus == 7">放款成功</span>
            <span v-if="scope.row.fileStatus == 8">放款成功</span>
            <span v-if="scope.row.fileStatus == 3">读取失败</span>
            <span v-if="scope.row.fileStatus == 4">放款失败</span>
          </template>
        </el-table-column>
